            ...
            >
              ...
              <div className="max-h-80 overflow-y-auto">
                {pending.length === 0 ? (
                  ...
                  pending.map((req, i) => {
                    const realIndex = requests.findIndex((r) => r.email === req.email && r.status === "pending");
                    return (
                      <motion.div
                        key={i}
                      ...
                      >
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-slate-400">{req.requestedAt}</p>
                          </div>
                        </div>
                        <div className="flex gap-2">
                          <motion.button
                            ...
                            whileTap={{ scale: 0.97 }}
                            onClick={() => { updateRequest(realIndex, "approved"); }}
                          ...
                          <motion.button
                            whileHover={{ scale: 1.03 }}
                            whileTap={{ scale: 0.97 }}
                            onClick={() => { updateRequest(realIndex, "rejected"); }}
